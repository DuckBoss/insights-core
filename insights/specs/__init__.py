...
class Specs(SpecSet):
    ...
    hostname = RegistryPoint(obfuscate=['hostname'])
    hostname_default = RegistryPoint(obfuscate=['hostname'])
    hostname_short = RegistryPoint(obfuscate=['hostname'])
    hosts = RegistryPoint(obfuscate=['hostname', 'ip'])
    ...
    ip_addr = RegistryPoint(obfuscate=['ip'])
    ...
    yum_repos_d = RegistryPoint(multi_output=True, obfuscate=['hostname'])
